	...
	<form id="form1" >
				...
				<nav>
					<ul id="showMainNav" class="fix">
						<li class="navContent nav_current">
							...
							data-url="${pageContext.request.contextPath}/user/manager.do">用户管理</a>
						</li>
						<li class="navContent">
							<a href="#" class="showNav" id="finance" data-name="main_iframe"
							onclick="Common.switchNavigation(this);"
							data-url="${pageContext.request.contextPath}/salary/manager.do">工资管理</a>
						</li>
					</ul>
				</nav>
			</div>
		...
		<div id="main_iframe"
			...
			<iframe class="main_iframe" id="home_iframe" frameborder="0"
				border="0" src="${pageContext.request.contextPath}/user/manager.do"></iframe>
		</div>
